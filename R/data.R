...
#' publications.
#' @author Chong Tang <chong.tang.mat@gmail.com>
#' @export
msdata2 <- function()
...
#' @title SWATH-MS Gold Standard Dataset Human
#'
#' @description
...
#' @title SWATH-MS Gold Standard Dataset Yeast
#'
#' @description
#' The SWATH-MS Gold Standard (SGS) dataset consists of 90 SWATH-MS runs of 422 synthetic
#' stable isotope-labeled standard (SIS) peptides in ten different dilution steps, spiked
...
#' See also http://www.openswath.org/openswath_data.html for details.
#'
#' @aliases Rost2014sgsYeast
#'
#' @docType data
#'
#' @usage Rost2014sgsYeast
#'
#' @format The data is an instance of class \code{MSnSet} from package \code{MSnbase}.
#'
#' @keywords datasets
...
#' @examples
#' Rost2014sgsYeast
#' exprs(Rost2014sgsYeast)
"Rost2014sgsYeast"


#' @title SWATH-MS Gold Standard Dataset Water
#'
#' @description
#' The SWATH-MS Gold Standard (SGS) dataset consists of 90 SWATH-MS runs of 422 synthetic
#' stable isotope-labeled standard (SIS) peptides in ten different dilution steps, spiked
...
#' See also http://www.openswath.org/openswath_data.html for details.
#'
#' @aliases Rost2014sgsWater
#'
#' @docType data
#'
#' @usage Rost2014sgsWater
#'
#' @format The data is an instance of class \code{MSnSet} from package \code{MSnbase}.
#'
#' @keywords datasets
